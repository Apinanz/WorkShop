...
public class UserController {
    ...
    @PostMapping(value="")
    public String store(@Validated({ com.training.platform.validators.Default.class, Extended.class })  User user,
    ...
    public String update(@PathVariable String id,
                         @Validated({ com.training.platform.validators.Default.class }) User user,
                         BindingResult bindingResult,
                         @RequestParam Map<String,String> inputs,
                         RedirectAttributes redirAttrs,
                         Model model) throws Exception {
